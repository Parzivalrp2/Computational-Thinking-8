# 
# This source file is just a python version of all the "official" words
# that can be answers (possible_answers) and which you are allowed to 
# guess (allowed_guesses) for the "official" implementation of Wordle.
# 
# Fun for experimenting with algorithms.
#
